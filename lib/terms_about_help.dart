...
Through Wazobia, you can donate your voice and validate other donations. We need to build an open-source voice database for African English dialects that anyone can use to make innovative voice recognition apps for devices and the web. You may only participate in Wazobia if you agree to these Terms.
...
4. Communications
If you subscribe to receive our newsletters or register for an account in connection with Wazobia, you may receive emails from us in connection with your account.
...
Any liability under this agreement is limited to \$500. You agree to indemnify and hold Wazobia harmless for any liability or claim that comes results from your participation in Wazobia. Wazobia provides the service “as is.” Wazobia specifically disclaims any legal guarantees or warranties such as “merchantability,” “fitness for a particular purpose,” “non-infringement,” and warranties arising out of a course of dealing, usage or trade.

6. Notices of Infringement  [TBD]
...
8. Termination
Wazobia can suspend or end anyone’s access to Wazobia at any time for any reason. If we decide to suspend or end your access, we will try to notify you by the email address associated with your account or the next time you attempt to access Wazobia. The recordings you submit to Wazobia will remain publicly available as part of Wazobia, even if we terminate or suspend your access.
